...
export function AppSidebar() {
  ...
  return <Sidebar className={open ? "w-60" : "w-14"}>
      <SidebarContent>
        <div className="px-6 py-6 border-b border-sidebar-border">
          {open ? <div className="flex flex-col items-center gap-3">
              <Avatar className="h-16 w-16">
                <AvatarImage src={logoIso} alt="ISO 8583" />
                <AvatarFallback>I8</AvatarFallback>
              </Avatar>
              <div className="text-center">
                <h2 className="text-lg font-bold text-sidebar-foreground">ISO 
8583 SIMULATOR</h2>
                <p className="text-xs text-sidebar-foreground/60">Transaction Monitor</p>
              </div>
        ...
        <div className="mt-auto border-t border-sidebar-border px-4 py-4">
          {open && <p className="text-xs text-sidebar-foreground/50 mb-2">Developed and created by</p>}
          <a 
