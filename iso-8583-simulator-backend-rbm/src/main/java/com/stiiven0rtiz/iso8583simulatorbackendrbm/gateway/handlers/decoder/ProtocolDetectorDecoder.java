...
import static com.stiiven0rtiz.iso8583simulatorbackendrbm.gateway.handlers.util.BytesParser.bytesToHex;
...
public class ProtocolDetectorDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) {
        ...
        logger.debug("{} - Incoming data (HEX): {}", thisId, toHexNoSpace(in));
